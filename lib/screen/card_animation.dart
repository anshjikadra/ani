...
class cardanimation extends StatefulWidget {
  @override
  State<cardanimation> createState() => _cardanimation();
}

class _cardanimation extends State<cardanimation> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Widgets that have global keys reparent their subtrees when they are moved from one location in the tree to another location in the tree. In order to reparent its subtree.',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 16,
