...
class loading_animation extends StatefulWidget {
  @override
  State<loading_animation> createState() => _loading_animation();
}

class _loading_animation extends State<loading_animation> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text("Loading Animation"),centerTitle: true),
      body: Center(
        child: Container(
          height: 100,
          width: 100,
